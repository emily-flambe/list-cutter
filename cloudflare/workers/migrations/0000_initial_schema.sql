...
-- This migration contains the complete, final database schema as of 2025-07-13
...
-- Views will be created after all tables are defined (moved to end of file)
...
-- Insert default quota configurations for new users (handled by application logic)
