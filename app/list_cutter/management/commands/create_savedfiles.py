...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i in range(5):
            ...
            if i > 0:
                saved_file_nodes[i].created_from.connect(saved_file_nodes[i - 1])
        ...
        for j in range(2):
            ...
            additional_file_node.created_from.connect(saved_file_nodes[0])
        ...
        for k in range(2):
            ...
            saved_file_nodes[5].created_from.connect(derived_file_node)
        ...
        saved_file_nodes[6].created_from.connect(final_file_node)
